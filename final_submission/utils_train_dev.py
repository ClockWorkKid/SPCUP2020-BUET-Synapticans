...
def dataLoading(path):
    ...
    x_df = df.drop(['class', "id", "time", "vel_lin_x","vel_lin_y","vel_lin_z", "pos_x","pos_z","pos_y"], axis=1)
...
def aucPerformance(mse, labels):
    roc_auc = roc_auc_score(labels, mse) # mse is the annomaly score and labels is the true labels
